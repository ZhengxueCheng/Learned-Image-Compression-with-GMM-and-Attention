...
#folder = 'valid/kodak/'
#folder = 'valid/raise/'
folder = 'valid/clicval_profession/'
#folder = 'valid/clicval_mobile/'
...
for image_file in glob(folder + '*' + img_format):
    ...
    os.system('python bls2017_joint_gmm_NLM.py --num_filters 128 --checkpoint_dir train_joint_6_MSSSIM_128filter_3x3(4)_v1.0_subpixel_GMM_NLM --verbose compress ' \
